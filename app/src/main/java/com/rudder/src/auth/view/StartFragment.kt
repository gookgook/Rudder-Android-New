...
class StartFragment : Fragment() {
    ...
    fun onClickLogin() {
        view?.let { Navigation.findNavController(it).navigate(R.id.action_fragment_start_to_fragment_login) }
    }
    fun onClickSignUp() {
        Log.d("reclick","reclickedSignup")
        view?.let { Navigation.findNavController(it).navigate(R.id.action_fragment_start_to_fragment_signup) }
    }
